...
<div align=center>
<img src="https://github.com/Timingswap/whitepaper/blob/main/TIMINGSWAP.jpg"  width="105" height="105"/> 
</div>
Introduction
...
3、	TimingGuarder:The feeto service charge of Timingswap is increased from 1 / 6 of uniswap v2 to 1 / 2, and the TimingGuarder contract address is setted to the feeto address. The contract has two main functions: (function convertweth and function getback)
